...
class Tr_Base_Class_V2{
    ...
    static function getLocationByIP($ip)
    {
    ...
    static function get_LocationHtml5()
    {
        ?>
<script>        
function trgetLocation(){if(navigator.geolocation){navigator.geolocation.getCurrentPosition(trshowPosition);}}        
